<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <title>Lista Produktow Pusta</title>
        </head>
                                ...
                                <form action="LoadProducts" method="Post">
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <input id="autocompleteMaps" placeholder="Caly swiat" type="text" name="address" class="form-control" />
                                            <script>
